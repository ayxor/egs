...
See [vault-agent/README.md](vault-agent/README.md) for the AppRole templates and rendered secret files used by each service.
...
The best place to read the actual endpoint contracts is [API_REFERENCE.md](API_REFERENCE.md).

For cluster deployment and Kubernetes topology, see [deployment_architecture.md](k8s/deployment_architecture.md).

For branch-level implementation docs, see:

- [Composer README](../composer/README.md)
- [IAM README](../iam/README.md)
- [Notifications README](../notifications/README.md)
- [Object Storage README](../object-storage/README.md)
- [Video Editor README](../video-editor/README.md)
- [Grafana README](grafana/README.md)
- [Vault Agent README](vault-agent/README.md)
